...
<body>
	...
	<div class="content">
		...
		<form method="post" action="updateLeaveServlet" onsubmit="">
			<table align="center">
				<tr>
					<td align="left">Employee Name :</td>
					<td align="left"><input id="eName" type="text" name="eName" value= ${ LeaveObj.geteName()}/></td>
				</tr>

				<tr>
					<td align="left">Department :</td>
					<td align="left"><input id="dName" type="text" name="dName" value= ${ LeaveObj.getdName()}/></td>
				</tr>

				<tr>
					<td align="left">Supervisor Name :</td>
					<td align="left"><input id="sName" type="text" name="sName" value= ${ LeaveObj.getsName()}/>
					</td>
				</tr>

				<tr>
					<td align="left">Date :</td>
					<td align="left"><input type="date" name="addeddate" value= ${ LeaveObj.getaddeddate()}>
				</tr>
	...
	<h3>
		...
		<div align="center">
			<label for="date"></label>
			 <input type="text" id="date" name="leaveDu" style="border:1px solid #28a7e9; padding: 1.0em ; width: 50%" value= ${ LeaveObj.getleaveDu()}>
