 ...
 <!-- register forum-->
   <div class="form">
      <div class="tab-content">
          ...
          <button class="button button-block" onclick="window.location.href='newFile.jsp'">Add Project</button>
		...
		<div class="login">
				...
				<button class="button button-block" onclick="window.location.href='Home.html'">BACK TO HomePage</button>
